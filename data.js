...
const REGISTER = [
  ...
  {n:'Waseem Goldenboy',    nhs:15.6,  whs:18.0,    calc:19.6,  rounds:25, est:true},
  ...
  {n:'Sid Amin',            nhs:17.2,  whs:20.1,    calc:22.4,  rounds:23, est:true},
  ...
  {n:'Imran K',             nhs:14.0,  whs:17.0,    calc:18.9,  rounds:21, est:true},
  {n:'Shaan Ahmed',         nhs:18.1,  whs:18,    calc:23.3,  rounds:15, est:false},
  {n:'Gazanfar Afzal',      nhs:12,    whs:12,    calc:18,    rounds: 1, est:false},
  {n:'Guftar Hussain',      nhs:7.9,   whs:10,    calc:11.7,  rounds:20, est:true},
