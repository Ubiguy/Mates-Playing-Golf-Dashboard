...
const REGISTER = [
  {n:'Yaseen Mohammed',     nhs:13.4,  whs:15.2,    calc:14.9,  rounds:18, est:false},
  {n:'Hamza T',             nhs:3,     whs:3,     calc:-3,    rounds: 3, est:false},
  {n:'Waseem Goldenboy',    nhs:15.6,  whs:18,    calc:19.6,  rounds:25, est:true},
  ...
  {n:'Sid Amin',            nhs:17.2,  whs:20.1,    calc:22,  rounds:23, est:true},
  ...
  {n:'Basharat2 Ali',       nhs:15.9,  whs:18.3,    calc:18.3,  rounds:13, est:false},
  {n:'Shazad Hussain',      nhs:19.9,  whs:21.6,    calc:22.4,  rounds:28, est:true},
  {n:'Aftab Iqbal',         nhs:6.8,   whs:9.4,     calc:6,     rounds: 2, est:false},
  {n:'Mansoor M',           nhs:16.1,  whs:19.9,    calc:20.9,    rounds:20, est:true},
  {n:'Tariq Javaid',        nhs:22.7,  whs:24.1,    calc:29.5,    rounds:14, est:false},
  ...
  {n:'Shufqat Khan',        nhs:12.7,  whs:15.9,    calc:16.2,  rounds:19, est:false},
  {n:'Imran K',             nhs:14.0,  whs:17,    calc:18.6,  rounds:21, est:true},
  {n:'Shaan Ahmed',         nhs:18.1,  whs:18,    calc:23.3,  rounds:15, est:false},
  {n:'Gazanfar Afzal',      nhs:12,    whs:12,    calc:18,    rounds: 1, est:false},
  {n:'Guftar Hussain',      nhs:7.9,   whs:9.6,    calc:11.7,  rounds:20, est:true},
  {n:'Raz Shafi',           nhs:10.6,  whs:11.7,    calc:14.2,    rounds:17, est:false},
  {n:'Afrid Iqbal',         nhs:10.6,  whs:10,    calc:14.3,    rounds: 9, est:false},
  {n:'Haaris Ahmed',        nhs:12.4,  whs:16.6,    calc:12.5,    rounds: 4, est:false},
